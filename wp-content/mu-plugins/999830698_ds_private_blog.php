	...
	function ds_login_header() {
		...
		<html xmlns="http://www.w3.org/1999/xhtml" <?php if ( function_exists('language_attributes') ) language_attributes(); ?>>
			<head>
				...
				<meta http-equiv="refresh" content="0;URL=<?php echo get_settings('siteurl'); ?>/wp-login.php" />
...
// hooks into Misc Blog Actions in SiteAdmin->Blogs->Edit
add_action('wpmueditblogaction', array(&$ds_more_privacy_options, 'wpmu_blogs_add_privacy_options'));
